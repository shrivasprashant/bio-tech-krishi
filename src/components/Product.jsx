    ...
    <div>
      ...
      <div class="grid items-start grid-cols-1 md:grid-cols-2 p-4 gap-12 max-w-6xl mx-auto">
        <div class="grid grid-cols-2 md:sticky top-0 gap-3">
          <div >
            <img className='w-[100%]' src="https://krishisevakendra.in/cdn/shop/files/400gm_11.webp?v=1700635430&width=823" alt="Product" class="w-full h-full object-cover object-top " />
          </div>
          <div>
            <img className='' src="https://krishisevakendra.in/cdn/shop/files/400gm_11.webp?v=1700635430&width=823" alt="Product" class="w-full h-full object-cover object-top " />
          </div>
          <div>
            <img className='' src="https://krishisevakendra.in/cdn/shop/files/400gm_11.webp?v=1700635430&width=823" alt="Product" class="w-full h-full object-cover object-top " />
          </div>
        ...
        <div class="max-lg:max-w-2xl">
          <div>
            <h2 class="text-2xl font-extrabold text-gray-800">KATYAYANI TRIPLE ATTACK | VERTICILLIUM LECANII + BEAUVERIA BASSIANA + METARHIZIUM ANISOPLIAE | BIO PESTICIDE</h2>
          ...
          <div class="mt-6">
            ...
            <div class="flex flex-wrap gap-2 mt-4">
              <button type="button" class="w-10 h-10 border-2 hover:border-gray-800 font-semibold text-gray-800 text-sm rounded-full flex items-center justify-center shrink-0">SM</button>
              <button type="button" class="w-10 h-10 border-2 hover:border-gray-800 border-gray-800 font-semibold text-gray-800 text-sm rounded-full flex items-center justify-center shrink-0">MD</button>
              <button type="button" class="w-10 h-10 border-2 hover:border-gray-800 font-semibold text-gray-800 text-sm rounded-full flex items-center justify-center shrink-0">LG</button>
              <button type="button" class="w-10 h-10 border-2 hover:border-gray-800 font-semibold text-gray-800 text-sm rounded-full flex items-center justify-center shrink-0">XL</button>
            </div>
          </div>

          <div class="mt-6">
            <p class="text-gray-800 text-2xl font-bold">Rs 300</p>
            <p class="text-gray-400 text-lg mt-1"><strike>price 999</strike> <span class="text-sm ml-1">Tax included</span></p>
          </div>
          ...
          <div class="mt-8 space-y-4 max-w-xs">
            <button type="button" class="w-full px-4 py-3 bg-gray-800 hover:bg-gray-900 text-white text-sm font-semibold rounded">Buy now</button>
            <button type="button" class="w-full px-4 py-2.5 border border-gray-800 bg-transparent hover:bg-gray-50 text-gray-800 text-sm font-semibold rounded">Add to cart</button>
          </div>
