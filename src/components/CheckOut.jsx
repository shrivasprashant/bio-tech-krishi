...
``
                <div className="flex items-start gap-4">
                  <div className="w-32 h-28 max-lg:w-24 max-lg:h-24 flex p-2 shrink-0 bg-gray-300 rounded-md">
                    <img src='https://images.unsplash.com/photo-1716927856017-ec6dd4e4021e?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxlZGl0b3JpYWwtZmVlZHwyM3x8fGVufDB8fHx8fA%3D%3D' className="w-full object-contain" />
                  </div>
                  <div className="w-full">
                    ...
                    <ul className="text-xs text-gray-300 space-y-1 mt-2">
                      ...
                      <li className="flex flex-wrap gap-4">Total Price <span className="ml-auto">300</span></li>
                    </ul>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div className="w-full">
                    ...
                    <ul className="text-xs text-gray-300 space-y-1 mt-2">
                      ...
                      <li>Total Price <span className="float-right">440</span></li>
                    </ul>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div className="w-full">
                    ...
                    <ul className="text-xs text-gray-300 space-y-1 mt-2">
                      <li>Size <span className="float-right">37</span></li>
                      <li>Quantity <span className="float-right">2</span></li>
                      <li>Total Price <span className="float-right">250</span></li>
                    </ul>
                  </div>
                </div>
