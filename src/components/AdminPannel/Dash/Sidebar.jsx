...
function Sidebar() {
  ...
  return (
    <>
      <div>
        <button
          className="md:hidden fixed top-4 left-2 z-50 text-xl bg-white p-2 rounded shadow"
        ...
        <nav
          className={`bg-white shadow-lg h-screen fixed top-0 left-0 md:min-w-[220px] py-4 px-4 font-[sans-serif] overflow-auto transition-transform transform ${
            isOpen ? "translate-x-0" : "-translate-x-full"
          } md:translate-x-0`}
        >
          <a href="#">
            <img
              src="../src/assets/BHARTIYA.jpg"
              alt="logo"
              className="w-[120px]"
            />
          </a>
            ...
            <ul className="mt-3">
              ...
              <li>
                ...
                >
                  ...
                  <span>
                    <Link to="/sliderUpload">Slider Image</Link>
                  </span>
                </a>
              </li>
            </ul>
