...
const Footer = () => {
  return (
    <footer className="bg-[#455f3f] font-[sans-serif]  text-white py-10 mt-6 ">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div>
            ...
            <ul className="flex space-x-4 mt-4">
              <li>
                <a href="https://www.facebook.com/share/WKoCRsfDFF6rd6YF/?mibextid=qi2Omg" className="hover:underline text-blue-600">
              ...
              <li>
                <a href="https://www.instagram.com/bhartiyabiotech?igsh=Z21va3cxZm9leTg0" className="hover:underline text-pink-700">
                  <svg aria-hidden="true" focusable="false" className="w-6 h-6" viewBox="0 0 18 18">
