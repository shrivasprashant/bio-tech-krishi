...
const Client = () => {
  return (
    <div>
      <div class="my-4 font-[sans-serif] text-[#333]">
            <div class="text-center max-w-xl mx-auto mb-12">
                <h2 class="text-3xl font-extrabold">What our happy client say</h2>
                <p class="text-sm mt-4 leading-relaxed">Veniam proident aute magna anim excepteur et ex consectetur velit ullamco veniam minim aute sit. Elit occaecat officia et laboris Lorem minim. Officia do aliqua.</p>
            </div>
            <div class="max-w-4xl mx-auto">
                <div class="grid md:grid-cols-2 items-center gap-8 max-w-4xl">
                    <div class="mx-auto">
                        <img src='https://plus.unsplash.com/premium_photo-1682092016074-b136e1acb26e?q=80&w=1887&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D' class="w-[280px] rounded-lg shadow-[-20px_20px_0px_rgba(23,219,220,1)]" />
                    </div>
                    <div>
                        <svg xmlns="http://www.w3.org/2000/svg" class="w-8 fill-blue-200 inline rotate-180" viewBox="0 0 475.082 475.081">
                        ...
                        <p class="text-sm mt-6 leading-relaxed">Veniam proident aute magna anim excepteur et ex consectetur velit ullamco veniam minim aute sit. Elit occaecat officia et laboris Lorem minim. Officia do aliqua adipisicing ullamco in.</p>
                        ...
                        <div class="mt-6">
                            <p class="text-base font-semibold">Simon Konecki</p>
                            <p class="text-xs text-gray-400">Founder of Labar</p>
                        </div>
                    </div>
                </div>
                <div class="flex justify-end mt-4 space-x-4">
                    <div class="bg-[#27852d] w-10 h-10 grid items-center justify-center rounded-full rotate-90 shrink-0 cursor-pointer">
