    ...
    <div>
      <div className="my-4 font-[sans-serif] text-[#333]">
        <div className="text-center max-w-xl mx-auto mb-12">
          ...
          We are committed to providing innovative solutions and quality products that enhance your farming practices and productivity.
          </p>
        </div>
        <div className="max-w-4xl mx-auto">
          <div className="grid md:grid-cols-2 items-center gap-8 max-w-4xl">
            <div className="mx-auto">
              <img
                src="https://plus.unsplash.com/premium_photo-1682092016074-b136e1acb26e?q=80&w=1887&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
            ...
            <div>
              <svg
                ...
                class="w-8 fill-blue-200 inline rotate-180"
              ...
              <p className="text-sm mt-6 leading-relaxed">
                <span> Quality Products:</span>  Our products are designed to meet the
                highest standards, ensuring the best outcomes for your fields. <br />
                <span>Innovative Solutions:</span> We bring the latest advancements in
                agricultural technology to your doorstep. <br />
                <span>Expert Support:</span> Our
                team of experts is always ready to assist you with any queries
          ...
          <div className="flex justify-end mt-4 space-x-4">
            <div className="bg-[#27852d] w-10 h-10 grid items-center justify-center rounded-full rotate-90 shrink-0 cursor-pointer">
              <svg
                xmlns="http://www.w3.org/2000/svg"
