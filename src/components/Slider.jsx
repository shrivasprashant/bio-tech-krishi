...
const Slider = () => {
    return (
        <div className=''>
            ...
            >
                <SwiperSlide>
                    <div className="h-[30vh] md:w-full md:h-[90vh]">
                ...
                <SwiperSlide>
                    <div className="h-[30vh] md:w-full md:h-[90vh]">
                        <img className='w-full h-full object-cover object-top' src="https://images.unsplash.com/photo-1709532390940-5c09fcdf098d?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="" />
                    </div>
                </SwiperSlide>
                <SwiperSlide>
                    <div className="h-[30vh] md:w-full md:h-[90vh]">
